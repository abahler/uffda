 ...
 *      Won't use an auth for this, so we have to ask: 
        What property of 'socket' object is unique for each tab, but stays the same on each refresh?
...
io.on('connection', (socket) => {   // A Socket.IO server is an EventEmitter, so we listen for events
    ...
    // console.log('io dot sockets dot clients: ', io.sockets.clients());
